...
import static org.xiao.ns.mapper.MemberDynamicSqlSupport.*;
...
@Mapper
public interface MemberMapper extends CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<Member>, CommonUpdateMapper {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertSelective(Member row) {
        return MyBatis3Utils.insert(this::insert, row, member, c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<Member> selectByPrimaryKey(Long id_) {
        return selectOne(c ->
            c.where(id, isEqualTo(id_))
        );
    }
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateAllColumns(Member row, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(Member row, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKey(Member row) {
        return update(c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKeySelective(Member row) {
        return update(c ->
